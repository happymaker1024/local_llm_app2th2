...
# 모델 받기
# 주의: neurlang/piper-onnx-kss-korean 모델은 phoneme_type이 "pygoruut"이라
#       piper-tts 패키지가 로드하지 못한다. 아래 공식 voice를 사용한다.
# cd /home/aiuser/local_llm_app2th/ollama_basic
# mkdir -p models/piper
# wget -O models/piper/ko_KR-kss-medium.onnx \
#   https://huggingface.co/rhasspy/piper-voices/resolve/main/ko/ko_KR/kss/medium/ko_KR-kss-medium.onnx
# wget -O models/piper/ko_KR-kss-medium.onnx.json \
...
# Piper 모델
PIPER_MODEL_FILE = Path("./models/piper/ko_KR-kss-medium.onnx")
PIPER_CONFIG_FILE = Path("./models/piper/ko_KR-kss-medium.onnx.json")
